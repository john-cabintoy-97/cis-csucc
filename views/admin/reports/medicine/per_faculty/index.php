            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">MEDICINE CONSUMED PER FACULTY REPORT</h5>
                ...
                <div id="printContainer">
                    ...
                    <div class="table-responsived">
                        <table id="datatable_per_fac" class="table table-borderless w-100">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <?php if ($lists->treat_med != '' && $patient->patient_type == 'faculty') : ?>
                                        <tr>
                                            <td><?= $counter++ ?></td>
