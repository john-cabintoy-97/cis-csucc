            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">TOTAL EMPLOYEE REGISTERED</h5>
                        <a href="<?= URL ?>admin/reports?r=medicine" class="btn bg-gradient-success"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Go Back</a>
                    </div>
                </h4>
                <hr>
                <div class="row mt-2 g-3 ">
                    <div class="col-auto row d-nxone">
                        <div class="col-auto">
                            <label class="form-control-plaintext">By Office:</label>
                        </div>
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1">
                                <select class="form-select" id="reg-semester" style="width:12em">
                                    ...
                                    foreach ($patient_list as $lists) {
                                        if ($value = $controllers->getByIdOffice($lists->patient_office_id)) {
                ...
                <div class="table-responsive">
                    <table id="datatable_reg_em" class="table table-borderless w-100">
                        ...
                        <tbody>
                            ...
                            foreach ($patient_list as $lists) {
                                ...
                                if ($lists->patient_type == "employee") {
                            ?>
                                    <tr>
                                        <td><?= $counter++; ?></td>
                                        ...
                                        <td><?= ucfirst($lists->patient_position); ?></td>
                                    </tr>
                            <?php
                                }
                            }
