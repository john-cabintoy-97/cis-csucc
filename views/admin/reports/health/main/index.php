    ...
    <div class="card-body">
        <h4 class="card-title">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="m-0 font-weight-bold text-success">HEALTH SERVICES LOG PAGE</h5>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-sm-6 mb-xl-0 mt-3 mb-4">
                <a href="<?= URL ?>admin/reports?r=health&ranges">
                    <div class="card">
            ...
            <div class="col-xl-12 col-sm-6 mb-xl-0 mt-3 mb-4">
                <a href="<?= URL ?>admin/reports?r=health&monthly">
                    <div class="card">
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-8">
            ...
            <div class="col-xl-12 col-sm-6 mb-xl-0 mt-3 mb-4">
                <a href="<?= URL ?>admin/reports?r=health&semester">
                    <div class="card">
                        <div class="card-body p-5">
                            <div class="row">
                                <div class="col-8">
