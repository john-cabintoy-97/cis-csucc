            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">EDIT STUDENTS FORM</h5>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-5 col-md-6 d-flex flex-column mx-auto bg-white m-5">
                        <form role="form" method="post" id="updateStudent">
                                    ...
                                    <div class="mb-2">
                                        <select class="form-select " name="course" id="courseCollege">
                                            ...
                                            <?php foreach ($course_drop as $lists) : ?>
                                                <option value="<?= $lists->course_id . '/' . $lists->college_id; ?>" <?= $data->patient_course_id === $lists->course_id ? "selected" : ""; ?>>
                                                    <?= $lists->course_name; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
