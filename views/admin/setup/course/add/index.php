            ...
            <div class="card-body p-3">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto bg-white m-5">
                        <form role="form" method="post" id="createCourse">
                            ...
                            <input type="hidden" name="createCourseSubmit">
                            <div class="text-center">
                                <button type="submit" name="courseButton" class="btn bg-gradient-success w-100 mt-4 mb-0">SUBMIT</button>
                            </div>
                        </form>
                    </div>
                </div>
