            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">HEALTH SERVICES LOGS BY DATE RANGES</h5>
                ...
                <div class="row mt-2 g-3">
                    <div class="col-auto row">
                        ...
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1 ">
                                <select class="form-select" id="healthfilter-option" style="width:12em">
                    ...
                    <div class="col-lg-auto row">
                        <div class="col-auto">
                            <label class="form-control-plaintext text-success">DATE RANGES:</label>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1 ">
                                <input type="date" class="form-control" id="hfrom-filter">
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1 ">
                                <input type="date" class="form-control" id="hto-filter">
                            </div>
                        </div>
                    </div>
                ...
                <div id="printContainer">
                    ...
                    <div class="table-responsived">
                        <table id="datatable_health_range" class="table table-borderless w-100">
