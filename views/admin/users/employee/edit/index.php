            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">EDIT EMPLOYEE FORM</h5>
                        <a href="<?= URL ?>admin/users?r=employee" class="btn bg-gradient-secondary"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Go Back</a>
                    </div>
                </h4>
                <div class="row">
                    <div class="col-xl-6 col-lg-5 col-md-6 d-flex flex-column mx-auto bg-white m-5">
                        <form role="form" method="post" id="updateEmployee">
                            ...
                            <div class="mb-2 row">
                                    ...
                                    <div class="mb-2">
                                        <select class="form-select " name="office">
                                            ...
                                            <?php foreach ($office_drop as $lists) : ?>
                                                <option value="<?= $lists->office_id; ?>" <?=  $data->patient_office_id === $lists->office_id ? 'selected' : ''?>>
                                                    <?= $lists->office_name; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="col-xl-6 col-lg-5 col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <input type="text" class="form-control" name="position" placeholder="Position" value="<?= $data->patient_position ?>">
