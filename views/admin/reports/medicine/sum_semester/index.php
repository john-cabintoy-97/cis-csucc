            ...
            <div class="card-body p-3">
                <h4 class="card-title">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-success">MEDICINE CONSUMPTION SUMMARY PER SEMESTER REPORT</h5>
                ...
                <div class="row mt-2 g-3">
                    <div class="col-auto row">
                        ...
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1 ">
                                <select class="form-select" id="sum-semester" style="width:12em">
                    ...
                    <div class="col-auto row">
                        ...
                        <div class="col-auto">
                            <div class="input-group input-group-sm p-1 ">
                                <select class="form-select" id="sum-sy" style="width:12em">
                ...
                <div id="printContainer">
                    ...
                    <div class="table-responsived">
                        <table id="datatable_semester_day" class="table table-borderless w-100">
                            <thead class="bg-gradient-success text-white">
                                <tr>
                                    <th>No.</th>

                                    <th class="d-none">Semester</th>
                                    <th class="d-none">S.Y</th>
